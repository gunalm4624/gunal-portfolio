  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 mt-8 lg:mt-18 px-4 lg:px-0">
      <div className="bg-white lg:col-span-8 rounded-[18px] p-6 lg:p-10 text-center lg:text-left">
        <h1 className='text-3xl sm:text-4xl lg:text-5xl tracking-tighter leading-tight lg:leading-14 font-medium'>Strategic UX, Beautiful UI, Measurable Impact</h1>
      ...
      <div className="bg-white lg:col-span-4 rounded-[18px] p-3 text-left">
        <div className="w-full h-64 sm:h-72 lg:h-78 bg-gray-100 rounded-[14px] flex items-end justify-center overflow-hidden">
            <img src="/images/gunal-photo.png" className='w-60 sm:w-70 lg:w-75' alt="" />
        </div>
        <div className='px-3 py-2 flex flex-col gap-0.5'>
        <h1 className='text-base sm:text-lg font-medium'>Gunal M</h1>
        <p className='text-xs sm:text-sm text-gray-600 mb-0'>Product Designer @ FSS</p>
        </div>
      </div>
    </div>
  )
