...
const ProjectTemplate = () => {
  return (
        <div className='mt-18 bg-white col-span-8 rounded-[18px] p-10'>
            <h1 className='text-5xl tracking-tighter leading-14 font-medium'>ResumeX</h1>
            <p className='mt-3 text-gray-600 text-sm'>SaaS MVP</p>
            <p className='mt-3 leading-8'>ResumeX is a web-based MVP that helps job seekers create, rewrite, and save resumes quickly, using a clean, modern UI and AI-powered rewriting. Its goal is to reduce the time and effort required to apply for jobs, providing an intuitive and efficient resume-building experience.</p>
            <div className="project-detail grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-12">
              <div className="w-full">
                ...
                <p className='mt-1 text-sm tracking-normal'>Personal Project</p>
              </div>
              <div className="w-full">
                <h1 className='font-medium text-lg'>Industries</h1>
                <p className='mt-1 text-sm tracking-normal'>Education</p>
              </div>
              <div className="w-full">
              ...
              <div className="w-full">
                ...
                <p className='mt-1 text-sm tracking-normal'>October 2025</p>
              </div>
            </div>
