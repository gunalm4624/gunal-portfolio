    ...
    <SmoothScrollWrapper className='mt-16 lg:mt-24 px-4 lg:px-0'>
        ...
        <Link href="/projects/ResumeX">
            <div className="bg-white rounded-[18px] p-2 hover:shadow-lg transition-shadow duration-300">
                <div className="w-full h-64 sm:h-72 lg:h-85 bg-gray-100 rounded-[12px] overflow-hidden relative p-4 sm:p-0">
                    <Image 
            ...
            <div className="bg-white rounded-[18px] p-2 hover:shadow-lg transition-shadow duration-300">
                <div className="w-full h-64 sm:h-72 lg:h-85 bg-gray-100 rounded-[12px] overflow-hidden relative p-4 sm:p-8">
                    <Image 
